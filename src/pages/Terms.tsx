      ...
      <div className="relative z-10 flex justify-center items-center min-h-screen px-6 py-10">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="rounded-lg border text-card-foreground shadow-sm overflow-hidden transition-all bg-background/50 backdrop-blur-sm border-purple-500/20 p-8">
            <h1 className="text-3xl font-bold mb-6 bg-gradient-to-r from-purple-500 to-blue-500 text-transparent bg-clip-text">Terms of Service</h1>
            
            <div className="space-y-6 text-sm">
              <section>
                <h2 className="text-xl font-semibold mb-2">1. Introduction</h2>
                <p className="text-muted-foreground mb-2">
                  Welcome to Barterly, a platform that enables users to exchange skills and services. These Terms of Service 
                  ("Terms") govern your access to and use of the Barterly website, applications, and services (collectively, the "Services").
                </p>
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  ...
                  (i) you are at least 18 years old; (ii) you have not previously been suspended or removed from the Services; and 
                  (iii) your registration and use of the Services is in compliance with all applicable laws and regulations.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-2">
                  To access certain features of the Services, you must register for an account. When you register, you agree to provide 
                  accurate, current, and complete information about yourself. You are solely responsible for maintaining the confidentiality 
                  of your account and password.
                </p>
                <p className="text-muted-foreground">
                  You agree to accept responsibility for all activities that occur under your account. If you have reason to believe that 
                  your account is no longer secure, you must immediately notify us at support@barterly.com.
                </p>
              </section>
              
              <section>
                <h2 className="text-xl font-semibold mb-2">4. Skill Marketplace</h2>
                <p className="text-muted-foreground mb-2">
                  Barterly provides a marketplace for users to offer and exchange skills and services. When offering your skills, you represent 
                  that you have the necessary expertise, qualifications, and legal right to provide such skills or services.
                </p>
                <p className="text-muted-foreground">
                  Barterly is not responsible for the quality, safety, legality, or any other aspect of the skills or services offered by users 
                  through the platform. We do not endorse any user or the skills or services they provide.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-2">
                  The Services may allow you to create, upload, post, send, receive, and store content. You retain ownership rights in the content 
                  you submit, but you grant Barterly a non-exclusive, transferable, sub-licensable, royalty-free, worldwide license to use, modify, 
                  publicly display, reproduce, and distribute such content on and through the Services.
                </p>
                <p className="text-muted-foreground">
                  You represent and warrant that: (i) you own the content you post on or through the Services or otherwise have the right to grant 
                  the rights described above; and (ii) your content does not violate the privacy rights, publicity rights, copyright rights, or other 
              ...
              <section>
                ...
                <ul className="list-disc pl-5 text-muted-foreground space-y-1">
                  ...
                  <li>Posting content that is defamatory, obscene, pornographic, abusive, offensive, or hateful</li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  We may terminate or suspend your access to all or part of the Services, with or without notice, for any conduct that we, 
                  in our sole discretion, believe violates these Terms or is harmful to other users of the Services, us, or third parties, 
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  Please review our <Link to="/privacy" className="text-purple-500 hover:underline">Privacy Policy</Link>, which explains 
                  how we collect, use, and share information about you when you access or use our Services.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  We may modify these Terms at any time. If we make changes, we will provide notice, such as by posting the updated Terms 
                  on the Services and updating the "Last Updated" date. Your continued use of the Services after such notice constitutes 
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  If you have any questions about these Terms, please contact us at support@barterly.com.
                </p>
              </section>
