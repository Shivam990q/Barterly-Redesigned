    ...
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 flex justify-center items-center min-h-screen px-6 py-10">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="rounded-lg border text-card-foreground shadow-sm overflow-hidden transition-all bg-background/50 backdrop-blur-sm border-purple-500/20 p-8">
            <h1 className="text-3xl font-bold mb-6 bg-gradient-to-r from-purple-500 to-blue-500 text-transparent bg-clip-text">Privacy Policy</h1>
            
            <div className="space-y-6 text-sm">
              <section>
                <h2 className="text-xl font-semibold mb-2">1. Introduction</h2>
                <p className="text-muted-foreground mb-2">
                  At Barterly, we value your privacy and are committed to protecting your personal data. This Privacy Policy explains 
                  how we collect, use, disclose, and safeguard your information when you use our platform.
                </p>
                <p className="text-muted-foreground">
                  Please read this Privacy Policy carefully. By accessing or using Barterly, you agree to the collection and use of 
              ...
              <section>
                ...
                <ul className="list-disc pl-5 text-muted-foreground space-y-1">
                  <li><span className="font-medium">Personal Information:</span> Name, email address, postal address, phone number, and other identifiers you provide when registering or updating your account.</li>
                  <li><span className="font-medium">Profile Information:</span> Skills, expertise, experience, education, and other information you choose to share on your profile.</li>
                  <li><span className="font-medium">Transaction Information:</span> Records of services exchanged, skill tokens earned or spent, and interactions with other users.</li>
                  <li><span className="font-medium">Communication Data:</span> Messages, reviews, and other communications between users on the platform.</li>
                  <li><span className="font-medium">Usage Information:</span> How you use our platform, including pages visited, features used, and actions taken.</li>
                  <li><span className="font-medium">Technical Data:</span> IP address, browser type and version, device information, operating system, and other technologies you use to access our platform.</li>
                </ul>
              </section>
              
              <section>
                <h2 className="text-xl font-semibold mb-2">3. How We Collect Your Information</h2>
                <p className="text-muted-foreground mb-2">
                  We collect information through:
                </p>
                <ul className="list-disc pl-5 text-muted-foreground space-y-1">
                  <li>Direct interactions when you create an account, complete your profile, or communicate with other users</li>
                  <li>Automated technologies or interactions, such as cookies and similar tracking technologies</li>
                  <li>Third-party sources, such as social media platforms if you choose to link them to your account</li>
                </ul>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc pl-5 text-muted-foreground space-y-1">
                  ...
                  <li>Process and track skill token transactions</li>
                  <li>Match you with relevant skill offerings based on your interests and needs</li>
                  <li>Communicate with you about our services, updates, and platform features</li>
                  <li>Monitor and improve our platform's performance and user experience</li>
              ...
              <section>
                ...
                <ul className="list-disc pl-5 text-muted-foreground space-y-1">
                  <li><span className="font-medium">Other Users:</span> Your profile information, skills, and other content you share will be visible to other users of the platform.</li>
                  <li><span className="font-medium">Service Providers:</span> Third-party vendors who perform services on our behalf, such as hosting, analytics, customer service, etc.</li>
                  ...
                  <li><span className="font-medium">Business Transfers:</span> In connection with a merger, acquisition, reorganization, or sale of our business or assets.</li>
                </ul>
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  We have implemented appropriate technical and organizational security measures designed to protect your personal information. However, please note that no method of transmission over the Internet or method of electronic storage is 100% secure.
                </p>
              </section>
              
              <section>
                <h2 className="text-xl font-semibold mb-2">8. Your Privacy Rights</h2>
                <p className="text-muted-foreground mb-2">
                ...
                <p className="text-muted-foreground mt-2">
                  To exercise these rights, please contact us at privacy@barterly.com.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  Our platform is not intended for children under 18 years of age. We do not knowingly collect personal information from children under 18. If you are a parent or guardian and you believe your child has provided us with personal information, please contact us.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  If you have any questions about this Privacy Policy, please contact us at privacy@barterly.com.
                </p>
              </section>
